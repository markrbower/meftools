...
void createAnalysisDatabase( const char* name ) {
	...
	cout << "creating subjects table" << endl;
    	dba.runSQL("create table subjects (uuid binary(16) DEFAULT (UUID_TO_BIN(UUID())) PRIMARY KEY, name varchar(64), species varchar(64), created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);" );
